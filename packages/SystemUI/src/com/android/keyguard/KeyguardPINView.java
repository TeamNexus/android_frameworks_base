...
public class KeyguardPINView extends KeyguardPinBasedInputView {
    ...
    protected void onFinishInflate() {
        ...
        boolean scramblePin = NexusSettings.getBoolForCurrentUser(getContext(), NexusSettings.SCRAMBLE_PIN_LAYOUT, false);
        if (scramblePin) {
        ...
        boolean quickUnlock = NexusSettings.getBoolForCurrentUser(getContext(), NexusSettings.QUICK_PIN_UNLOCK, false);
        if (quickUnlock) {
